...
const Tesrimonial = (props) => {
    ...
    return(
        <div className="w-[85vw] md:w-[700px] bg-white flex flex-col
            ...
            hover: shadow-xxl rounded-md ">
            <Card review = {reviews[index]}></Card>



            <div className=" text-center flex text-3xl mt-10 gap-3 text-violet-400 font-bold mx-auto ">
                <button 
            ...
            <div className="mt-6">
                <button
                    ...
                    className="bg-violet-400 hover:bg-violet-500 transition-all duration-75
